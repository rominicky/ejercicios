...
YouTube_Canales <- read.csv(file = "/home/rodrigososatoranzo/Descargas/Base de datos v1.4 - 2024 - Nodes.csv", header = TRUE, sep = ",") #cargamos base de datos sobre canales de Youtube en Argentina
